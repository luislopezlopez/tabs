...
//import { resultadosConc } from '../pages/ligas/ligas'; // esta la tengo que convertir a leerla desde la memoria!!!! 
//var tablaConc="Tabla Nueva2"
//var resultadosConc="Resultados Nueva2";
var numEquipos=0;
var arrkeys=[];
var arrg =[];
var arrEquipos =[];
...
export class Resultadosfirebase {
  ...
  user2 : FirebaseListObservable<any>;
  	constructor(public database: AngularFireDatabase,public storage: Storage) { 
		...
		//DG//
		 dg1=0;  dg2=0;  dg3=0;  dg4=0; dg5=0;  dg6=0;  dg7=0;  dg8=0; dg9=0;  dg10=0;  dg11=0;  dg12=0; dg13=0;  dg14=0;  dg15=0;  dg16=0; dg17=0;  dg18=0;
          ...
          arrGolLocal[i]=arr[i].gol1 ; //arreglo goles local
			  ...
			  //gana local, meto las posibles combinaciones, en este caso solo 4 equipos para probar
